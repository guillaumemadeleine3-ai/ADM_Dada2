...
```
```{r}
taxa <- assignTaxonomy(seqtab.nochim, "/home/rstudio/ADM_Test/silva_nr99_v138.1_train_set.fa.gz?", multithread=TRUE)
```
...
BiocManager::install("phyloseq", update = FALSE, force = TRUE)
```
```{r}
